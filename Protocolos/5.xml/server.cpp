...
int main(int argc, char const *argv[]){
    ...
    for (;;){
        ...
        do{
            ...
            cout<<"Cliente envió informacion en XML: \n"<<buffer<<endl;
            char tmp[10000];
            char var[10000];
            int cont=0;
            int k=0;
            for (int i = 9; i < strlen(buffer)-9; i++){
                if(buffer[i]!=','){
                    tmp[cont]=buffer[i];
                    cont++;
                }
                    ...
                    if(tmp[1]=='p'){
                        if (tmp[2]=='r'){
                            for (int j = 12; j<strlen(tmp)-13; j++){
                                var[k]+=tmp[j];
                                k++;
                            }
